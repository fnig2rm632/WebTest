        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerWhiteId = table.Column<string>(type: "text", nullable: false),
                    PlayerBlackId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Game_AspNetUsers_PlayerBlackId",
                        column: x => x.PlayerBlackId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Game_AspNetUsers_PlayerWhiteId",
                        column: x => x.PlayerWhiteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Game_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Game_PlayerBlackId",
                table: "Game",
                column: "PlayerBlackId");

            migrationBuilder.CreateIndex(
                name: "IX_Game_PlayerWhiteId",
                table: "Game",
